...
public class EmailVerificationService {
    ...
    public void onUserRegistered(UserRegisteredEvent event) {
        doSendVerificationEmail(event.userId());
    }
    ...
    public void resendVerificationEmail(String email) {
        ...
        doSendVerificationEmail(user.getId());
    }
    ...
    private void doSendVerificationEmail(UUID userId) {
        ...
        String verificationUrl = baseUrl + "/email-verification/verify-email?token=" + token;
